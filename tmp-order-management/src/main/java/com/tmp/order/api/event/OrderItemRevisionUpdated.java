...
/**
 * Published after a successful {@code ORDER_ITEM_REVISION_UPDATE} post (Specification §17).
 */
public final class OrderItemRevisionUpdated extends AbstractDomainEvent {
    ...
    public OrderItemRevisionUpdated(OrderItemId orderItemId, RevisionNumber revisionNumber) {
        this(orderItemId, revisionNumber, null);
    }

    public OrderItemRevisionUpdated(
