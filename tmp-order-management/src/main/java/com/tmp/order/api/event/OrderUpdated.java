...
/**
 * Published after a successful {@code ORDER_UPDATE} post (Specification §17).
 */
public final class OrderUpdated extends AbstractDomainEvent {
    ...
    public OrderUpdated(OrderId orderId, String actor) {
