...
/**
 * Published after a successful {@code ORDER_CANCEL} post (Specification §17).
 */
public final class OrderCancelled extends AbstractDomainEvent {
    ...
    public OrderCancelled(OrderId orderId, String actor) {
