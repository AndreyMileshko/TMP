...
/**
 * Published after a successful {@code ORDER_ITEM_CANCEL} post (Specification §17).
 */
public final class OrderItemCancelled extends AbstractDomainEvent {
    ...
    public OrderItemCancelled(OrderId orderId, OrderItemId orderItemId) {
        this(orderId, orderItemId, null);
    }

    public OrderItemCancelled(OrderId orderId, OrderItemId orderItemId, String actor) {
