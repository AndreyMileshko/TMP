...
/**
 * Published after a successful {@code ORDER_APPROVE} post (Specification §17).
 */
public final class OrderApproved extends AbstractDomainEvent {
    ...
    public OrderApproved(OrderId orderId) {
        this(orderId, null);
    }

    public OrderApproved(OrderId orderId, String actor) {
