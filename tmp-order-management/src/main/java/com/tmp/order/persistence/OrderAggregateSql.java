...
final class OrderAggregateSql {
    ...
    static final String INSERT_ORDER_ITEM =
            ...
            INSERT INTO order_management.order_items
              (order_item_id, order_id, product_code, item_name, comments, status,
               active_revision_number, draft_revision_number, version, created_at, updated_at)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """;
    ...
    static final String UPDATE_ORDER_ITEM =
            ...
            SET product_code = ?, item_name = ?, comments = ?, status = ?,
                active_revision_number = ?, draft_revision_number = ?,
                version = version + 1, updated_at = ?
    ...
    static final String SELECT_SPEC_LINES_BY_KEY =
            """
            SELECT line_number, material_code, material_name, quantity, unit_of_measure,
                   consumption_norm
