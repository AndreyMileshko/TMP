...
9. После утверждения применяются обычные правила неизменяемости; утверждённая позиция всегда имеет `productCode` и `name`.
