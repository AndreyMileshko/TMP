...
|---|---|
| STAGE6-007 | DONE |
| Receipt unit tests | PASS (4) |
| Receipt integration tests | PASS (2) |
| Warehouse module tests | PASS (50) |
...
|---|---|
| STAGE6-005 | DONE |
| Warehouse Movement unit tests | PASS (4) |
| Warehouse Movement repository IT | PASS (2) |
| Warehouse module tests | PASS (35) |
