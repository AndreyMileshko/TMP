...
| 3.5.15 | Manual Warehouse acceptance | **IN PROGRESS** (Stocks-centric UX + Stocks UX + Production acceptance-state + Warehouse-managed production destination COMPLETE; Manual acceptance READY TO RESUME FROM Склад → Остатки; Full reactor NOT YET RUN) |
