...
| 3.5.15 | Manual Warehouse acceptance | **IN PROGRESS** (Stocks UX + Production acceptance-state + Warehouse-managed production destination COMPLETE; Manual acceptance READY TO RESUME AFTER USER ASSIGNS PRODUCTION WAREHOUSE; Full reactor NOT YET RUN) |
