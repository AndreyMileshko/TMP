...
| 3.5.15 | Manual Warehouse acceptance | **IN PROGRESS** (Stocks UX + Production acceptance-state correctives COMPLETE; Manual acceptance READY TO RESUME from Production → Material Requirement; Full reactor NOT YET RUN) |
