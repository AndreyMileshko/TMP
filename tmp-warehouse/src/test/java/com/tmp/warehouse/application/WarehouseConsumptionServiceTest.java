...
class WarehouseConsumptionServiceTest {
    ...
    void successfulConsumptionDecreasesStockAndRecordsNegativeMovement() {
        ...
        WarehouseOperation completed =
                consumption.consume(
                        new ConsumptionRequest(
                                material, StockQuantity.of(30L), warehouseId, cellId));
        ...
        assertEquals(StockQuantity.of(70L), completed.quantity());

        StockPosition position =
                stockPositions
                        .findByNaturalKey(warehouseId, cellId, material, StockState.AVAILABLE)
                        .orElseThrow();
        assertEquals(StockQuantity.of(70L), position.quantity());
        ...
        assertEquals(0, history.get(0).quantityDelta().compareTo(BigDecimal.valueOf(-30L)));
    }
    ...
    void insufficientStockRejected() {
        ...
        assertThrows(
                ...
                () ->
                        consumption.consume(
                                new ConsumptionRequest(
                                        material, StockQuantity.of(11L), warehouseId, cellId)));
    ...
    void missingStockRejected() {
        ...
        assertThrows(
                ...
                () ->
                        consumption.consume(
                                new ConsumptionRequest(
                                        material, StockQuantity.of(5L), warehouseId, cellId)));
    ...
    @Test
    void consumptionRejectsZeroQuantity() {
        assertThrows(
    ...
    @Test
    void consumptionRejectsNegativeQuantity() {
        assertThrows(
                IllegalArgumentException.class,
                () ->
                        new ConsumptionRequest(
