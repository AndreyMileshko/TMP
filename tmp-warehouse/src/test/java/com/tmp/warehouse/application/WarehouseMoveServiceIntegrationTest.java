...
/**
 * Integration tests: Move persists Operation, Movements and updated Stock Positions.
 */
@Testcontainers
class WarehouseMoveServiceIntegrationTest {

    private static final Clock CLOCK =
            Clock.fixed(Instant.parse("2026-08-07T16:30:00Z"), ZoneOffset.UTC);
    ...
    @Test
    void movePersistsOperationMovementsAndStock() {
        ...
        catalog.insert(Warehouse.create(warehouseId, "WH-MOV-1", "Main"));
        ...
        assertTrue(sourceHistory.get(0).quantityDelta().signum() < 0);
